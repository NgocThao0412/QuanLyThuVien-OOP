...
public class DanhSachNhanVien implements DanhSachChung {
    ...
    public void setDsNhanVien(PhanTu[] dsSanPham) { // ghi file
        ...
        for (int i = 0; i < soLuong; i++) {
            ...
            FileHandler.themNv(nv.getManhanvien(), nv.getHoten(), nv.getChucvu(), nv.getNgaythangnamsinh(), nv.getGioitinh(), nv.getCCCD(), nv.getDiachi(), nv.getSdt(), nv.getEmail(),nv.getNgayvaolam(), nv.getHesoluong(), nv.getSongaynghitrongthang());
        }
