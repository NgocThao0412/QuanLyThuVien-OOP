...
public class DanhSachTaiKhoan implements DanhSachChung {
    ...
    public void setDsTaiKhoan(PhanTu[] dsSach) { //ghi file
        TaiKhoan tk;
    ...
    public void nhapDanhSach() {
        ...
        for (int i = 0; i < soLuongCurrent; i++) {
            ...
            System.out.println("** Nhap tai khoan thu " + stt + " **");
            dsTaiKhoan[i].nhap();
    ...
    public PhanTu timPhanTu() {
        ...
        if (loai == 2) 
            System.out.print("Nhap mat khai tai khoan can tim: ");
