...
public class SachTrinhTham extends Sach {
    ...
    public SachTrinhTham() {
        super();
        setLoaiSach("Sach Trinh Tham");
    }

    public SachTrinhTham(String maSach, String tenSach, String tacGia,
                         int soLuong, int price, String nhaXuatBan) {
        super(maSach, tenSach, tacGia, "Sach Trinh Tham", soLuong, price);
    ...
    public void suaThongTin() {
        int chon;
        do {
            System.out.println("=== Sua thong tin Sach Trinh Tham ===");
